...
# condição para venda de ingressos com 3 opções de filmes
    if idade < 3:
        ...
        filmes = ['Chico Bento e a goiabeira maraviosa', 'Deu Preguiça']
        ...
        filmes = ['Lobisomem', 'Seven - Os sete crimes capitais', 'Capitão América - Admiravel mundo novo', 'Conclave', 'O auto da compadecida 2']
